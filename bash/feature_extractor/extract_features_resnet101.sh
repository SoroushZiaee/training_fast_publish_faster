...
# srun python extract_layer_features.py --model resnet101 --task lamem_shuffle_pretrain_freeze
srun python extract_layer_features.py --model resnet101 --task no_model
