...
# srun python -m memory_profiler extract_layer_features.py --model vgg16 --task lamem_shuffle_pretrain_freeze
srun python -m memory_profiler extract_layer_features.py --model vgg16 --task no_model
