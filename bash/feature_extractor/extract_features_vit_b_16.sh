...
# srun python extract_layer_features.py --model vit_b_16 --task lamem_shuffle
# srun python extract_layer_features.py --model vit_b_16 --task lamem_pretrain_freeze
# srun python extract_layer_features.py --model vit_b_16 --task lamem_pretrain_no_freeze
# srun python extract_layer_features.py --model vit_b_16 --task lamem_shuffle_pretrain_freeze
srun python extract_layer_features.py --model vit_b_16 --task no_model
